...
def main() -> None:
    ...
    metadata = {
        ...
        "grid_cell_pixels": 4,
        "person_radius_meters": 0.18,
        "walking_speed_mps": 1.20,
        "default_start_anchor": {
            "source": "operator_admin_anchor_percent_v7",
            "reference_pixels": [2219.862, 677.483],
            "direction_pixels": [1997.346, 699.941],
            "coordinate_system": "plan_percent",
            "reference_percent": [41.9, 18.1],
            "direction_percent": [37.7, 18.7],
